...
export declare function createLocalEnvironment(options: { directory: string; profiles: Record<string, LocalProfile>; docker?: string; fetch?: typeof globalThis.fetch }): Promise<EnvironmentHandler>;
