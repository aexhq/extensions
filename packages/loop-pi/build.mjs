...
import { compatRewrite } from "./src/compat.mjs";

const here = (path) => fileURLToPath(new URL(path, import.meta.url));
const pkg = JSON.parse(await readFile(here("./package.json"), "utf8"));

const bundle = await buildAgentloopComponent(
  {
    entry: here("./src/loop.mjs"),
    plugins: [compatRewrite],
    inject: [here("./src/polyfill.mjs")],
  },
  componentize,
);
