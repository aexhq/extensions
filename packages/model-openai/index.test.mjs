...
const request = { model: "gpt-test", messagesJson: JSON.stringify([{ role: "user", content: [{ type: "text", text: "hi" }] }]), toolsJson: "[]", responseFormatJson: undefined, generationJson: JSON.stringify({ max_tokens: 100 }), providerOptionsJson: JSON.stringify({ baseUrl: "https://api.example", apiKey: "secret" }), deadlineAtMs: 1n };
